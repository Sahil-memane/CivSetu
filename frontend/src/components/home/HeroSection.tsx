...
import { MapPin, Camera, Users, ArrowRight, CheckCircle2 } from "lucide-react";
...
export function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: "2s" }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full border border-primary/20">
              ...
              <span className="text-sm font-medium text-primary">Now Live in 50+ Cities</span>
            </div>
            ...
            <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
              Report civic issues like potholes, water leaks, and broken streetlights. 
              Track resolutions in real-time and help build a cleaner, safer community for everyone.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-6 pt-4">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <span>50,000+ Issues Resolved</span>
              </div>
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <Users className="w-5 h-5 text-primary" />
                <span>1 Million+ Citizens</span>
              </div>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative z-10">
              ...
              {/* Floating Cards */}
              <div className="absolute -left-8 top-20 glass-card rounded-2xl p-4 shadow-xl animate-float" style={{ animationDelay: "0s" }}>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-warning/20 flex items-center justify-center">
                    <div className="w-5 h-5 rounded-full bg-warning" />
                  </div>
                  <div>
                    <p className="text-xs text-muted-foreground">Pothole Reported</p>
                    <p className="font-semibold text-sm">MG Road, Sector 5</p>
                  </div>
                </div>
              </div>

              <div className="absolute -right-4 top-1/2 glass-card rounded-2xl p-4 shadow-xl animate-float" style={{ animationDelay: "2s" }}>
                <div className="flex items-center gap-3">
              ...
              <div className="absolute -left-4 bottom-20 glass-card rounded-2xl p-4 shadow-xl animate-float" style={{ animationDelay: "4s" }}>
                <div className="flex items-center gap-3">
